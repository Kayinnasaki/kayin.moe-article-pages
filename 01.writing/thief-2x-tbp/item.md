---
title: Game Journal: Thief 2X and The Black Parade
subtitle: Thief is the Doom of Stealing Sims
published: true
...
Ultimately it's just an incredible mod and anyone vaguely into Thief should play it. If you don't want to read me talk about more spoilery stuff, click [here](#thief-2x).

[floatbox type="full"]
![](tbpspoiler.png?lightbox)
<small>(A convenient spoiler break)</small>
[/floatbox]
...
... The "problem" is that she's aggressively feminine... And she talks like a [tool tip="I don't know if Zaya is canonically like 18 or w/e but she sure acts it"]teenager[/tool]. She has unstable emotions like a teenager. If shitty gamer men find women grating, a *teenage woman* is unbearable. I found her charming.
...
* Finding a version of this you can actually install with a thief FM launcher is a pain in the ass. The one on [their site](https://www.thief2x.com/) won't work anymore.
...
Anyways, spoilers again, so feel free to skip to [here](#darkmod).

[floatbox type="full"]
![](2xspoiler.png?lightbox)
<small>(Are you supposed to aim *in* the ring, or using the pinch???)</small>
[/floatbox]
...
I'm not going to go crazy talking about it because I only did the two missions included with the download, but I still want to point out [Darkmod](https://www.thedarkmod.com/media/). Originally a Doom 3 mod, with the release of **Doom 3**'s source code it was able to become an independent project. Like Doom 3, Darkmod looks *great*. The engine was basically made for rich shadows, so it fits thief perfectly.
